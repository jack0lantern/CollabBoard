...
/** Triangle points: top center, bottom left, bottom right (relative to top-left bounding box) */
function getTrianglePoints(width: number, height: number): number[] {
...
export function TriangleShape({
  ...
  const points = getTrianglePoints(absWidth, absHeight);
        ...
        <Line
          ...
          stroke={
            (data.strokeWidth ?? 0) > 0
              ? (data.strokeColor ?? data.color ?? "#d97706")
