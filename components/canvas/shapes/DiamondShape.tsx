...
/** Diamond points: top, right, bottom, left (relative to top-left bounding box) */
...
export function DiamondShape({
  ...
  const points = getDiamondPoints(absWidth, absHeight);
        ...
        <Line
          ...
          stroke={
            (data.strokeWidth ?? 0) > 0
              ? (data.strokeColor ?? data.color ?? "#7c3aed")
